...
BEGIN
    RAISERROR(N'Competition לא נמצא: תחרות ריינינג 9+10', 16, 1);
    ROLLBACK TRAN;
    RETURN;
END;
...
(12, 262, 98, 3, 348, 348, 465, 622, N'כרמון אייל', '2025-09-27 00:00:00', N'exact'),
(15, 117, 98, 4, 173, 372, 360, 519, N'ג''רבי מירב', '2025-09-27 00:00:00', N'exact'),
(18, 457, 98, 5, 2348, 2348, 377, 622, N'רקח גל', '2025-09-27 00:00:00', N'exact'),
...
(70, 126, 100, 9, 1082, 2348, 260, 622, N'דמתי דביר', '2025-09-27 00:00:00', N'exact'),
...
(174, 351, 102, 2, 1763, 201, 385, 622, N'סייג משה', '2025-09-27 00:00:00', N'exact'),
...
(198, 424, 103, 4, 315, 133, 292, 622, N'קולטין אפי', '2025-09-27 00:00:00', N'exact'),
...
(226, 244, 104, 3, 2348, 2348, 448, 622, N'כנעני צביקה', '2025-09-27 00:00:00', N'rider_horse_unique'),
(234, 23, 105, 5, 285, 374, 327, 2372, N'איתי זוהר', '2025-09-27 00:00:00', N'rider_horse_unique'),
...
(266, 248, 104, 12, 2348, 2348, 449, 622, N'כנעני צביקה', '2025-09-27 00:00:00', N'exact'),
...
(339, 263, 108, 15, 348, 348, 465, 622, N'כרמון אייל', '2025-09-27 00:00:00', N'rider_horse_unique'),
(398, 291, 112, 4, 43, 133, 283, 622, N'לוגסי נדב', '2025-09-27 00:00:00', N'exact'),
(414, 226, 111, 8, 2567, 133, 263, 622, N'כמכאג''י רות', '2025-09-27 00:00:00', N'exact'),
(436, 49, 112, 13, 249, 368, 387, 398, N'ארצי רביב', '2025-09-27 00:00:00', N'exact'),
(440, 369, 112, 14, 704, 133, 335, 622, N'סלמן יסמין', '2025-09-27 00:00:00', N'rider_horse_unique'),
...
(669, 15, 119, 3, 2785, 133, 260, 622, N'אטיה פלג', '2025-09-27 00:00:00', N'exact'),
...
(689, 425, 120, 4, 315, 133, 292, 622, N'קולטין אפי', '2025-09-27 00:00:00', N'exact'),
...
(804, 237, 122, 18, 2348, 2348, 488, 622, N'כנעני צביקה', '2025-09-27 00:00:00', N'rider_horse_unique'),
...
(973, 292, 130, 10, 43, 133, 283, 622, N'לוגסי נדב', '2025-09-27 00:00:00', N'exact'),
(1011, 233, 129, 15, 3207, 2348, 382, 622, N'כנעני צביקה', '2025-09-27 00:00:00', N'rider_horse_unique'),
...
INSERT INTO #PayerMap (PayerRaw, PayerPersonId)
SELECT N'קרא עדי', 488
WHERE NOT EXISTS (
    SELECT 1 FROM #PayerMap WHERE PayerRaw = N'קרא עדי'
);

INSERT INTO #PayerMap (PayerRaw, PayerPersonId)
SELECT N'איתי זוהר', p.PersonId
FROM Person p
WHERE p.FirstName = N'איתי'
  AND p.LastName = N'זוהר'
  AND NOT EXISTS (
      SELECT 1 FROM #PayerMap WHERE PayerRaw = N'איתי זוהר'
  );
...
(N'Tack', N'יפעת',     NULL, NULL, NULL, 515, 488, 11, 1, 52, N'604',  3, '2025-10-14', '2025-10-18', 1, N'ציוד יפעת - מאיה קרא'),
...
FROM StallBooking sb
JOIN ProductRequest pr ON pr.PRequestId = sb.StallBookingId
JOIN Bill b ON b.PaidByPersonId = 488
