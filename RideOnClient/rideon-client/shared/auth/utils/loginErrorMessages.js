...
// משותף בין מובייל ווב (הועבר לכאן מ-mobile/src/utils/loginErrors.js
// במסגרת ביקורת ההתראות של RideOn, 2026-08-07 - שני האפליקציות סבלו מאותה
// דליפת טקסט אנגלי גולמי ממסך ההתחברות, ולמובייל כבר היה מיפוי מוקשח).
//
