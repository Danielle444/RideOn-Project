...
// WorkerCompetitionsBoardScreen imports react-native/context modules, not safe to
...
var SOURCE_PATH = path.resolve(__dirname, "WorkerCompetitionsBoardScreen.jsx");

function readSource() {
  return fs.readFileSync(SOURCE_PATH, "utf8").replace(/\r\n/g, "\n");
}

describe("WorkerCompetitionsBoardScreen - stale competition-menu reset on focus", () => {
