...
export default function AdminCompetitionClassesScreen(
  props,
) {
  ...
  var entries =
    useAdminCompetitionEntriesList({
      activeRole: activeRole,
      activeCompetition: activeCompetition,
    });

  var [showFilters, setShowFilters] =
    useState(false);
  ...
  function renderSummaryBox(
    ...
    var isActive =
      entries.paymentFilter === filterValue;
    ...
    return (
      <Pressable
        style={[
          styles.summaryBox,
          isActive
            ? styles.summaryBoxActive
            : null,
        ]}
        onPress={function () {
          entries.setPaymentFilter(
            filterValue,
          );
        }}
      >
        ...
        <View style={styles.chipsRow}>
          {renderFilterChip(
            ...
            entries.dateFilter ===
              "all",
            function () {
              entries.setDateFilter(
                "all",
              );
            },
          )}

          {entries.availableDates.map(
            function (dateItem) {
  ...
  function renderContent() {
    ...
    return entries.filteredItems.map(
      function (item) {
  ...
  return (
    <MobileScreenLayout
      ...
      bottomNavItems={getAdminBottomNavConfig(
        props.navigation,
      )}
