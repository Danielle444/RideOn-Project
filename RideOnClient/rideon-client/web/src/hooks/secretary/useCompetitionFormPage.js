...
export default function useCompetitionFormPage(options) {
  ...
  return {
    ...
    savingReschedule: details.savingReschedule,
    dateChangeConfirm: details.dateChangeConfirm,
    confirmDateChange: details.confirmDateChange,
    cancelDateChangeConfirm: details.cancelDateChangeConfirm,
    dateChangeConfirmLabel: details.dateChangeConfirmLabel,
    dateChangeCancelLabel: details.dateChangeCancelLabel,
    ...
    classDeleteConfirm: classes.classDeleteConfirm,
    closeClassDeleteConfirm: classes.closeClassDeleteConfirm,
    ...
    paidTimeDeleteConfirm: paidTime.paidTimeDeleteConfirm,
    closePaidTimeDeleteConfirm: paidTime.closePaidTimeDeleteConfirm,
    shouldShowPaidTimeStep: shouldShowPaidTimeStep,
