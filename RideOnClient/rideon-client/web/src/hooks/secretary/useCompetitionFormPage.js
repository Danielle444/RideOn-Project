...
export default function useCompetitionFormPage(options) {
  ...
  return {
    ...
    rescheduleModalOpen: details.rescheduleModalOpen,
    savingReschedule: details.savingReschedule,
    openRescheduleModal: details.openRescheduleModal,
    closeRescheduleModal: details.closeRescheduleModal,
    handleReschedule: details.handleReschedule,
